...
async def task():
    ...
    while True:
        ...
        prompt_template = ChatPromptTemplate.from_messages([
            ("system", "You are a helpful assistant. Answer ONLY using the context below. If the answer is not in the context, say 'I don't know'."),
            ("human", "{input}")
        ])
        ...
        print("LLM Response:", response1.content)
